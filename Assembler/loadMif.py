...
java_file = "Assembler"
output_mif = project_root / "testbenches" /"dual_issue_inst_memory.mif"
output_mif_superscalar = project_root / "SuperScalar" /"dual_issue_inst_memory.mif"
...
assembler_dir.mkdir(parents=True, exist_ok=True)
output_mif_superscalar.parent.mkdir(parents=True, exist_ok=True)
...
with open(output_mif_superscalar, "w") as mif_file:
    subprocess.run(
        ["java", java_file],
        cwd=assembler_dir,
        stdout=mif_file,
